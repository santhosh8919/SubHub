...
?>
    <div class="products">
      <div class="container">
        <h1><i class="fa-solid fa-tags"></i> Subscription Plans&nbsp;<a class="btn btn-outline-primary" href="./edit-products.php?do=add-new">Add New Plan</a></h1>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <?php foreach ($products as $product) : ?>
                <tr>
                  <td>
                    <img class="img-avatar-product rounded" src="../uploads/<?php echo $product['img_product']; ?>" alt="<?php echo $product['name_product']; ?>" style="width: 40px; height: 40px; object-fit: contain;">
                    <strong><?php echo $product['name_product']; ?></strong>
                  </td>
                  <td><?php echo $product['company_name'] ?? '-'; ?></td>
                  <td><span class="badge bg-primary"><?php echo $product['category'] ?? 'General'; ?></span></td>
                  <td>$<?php echo $product['price_product']; ?></td>
                  <td><span class="badge bg-secondary"><?php echo ucfirst($product['billing_cycle'] ?? 'monthly'); ?></span></td>
                  <td>
                    <form action="./edit-products.php?do=action" method="post">
                      <input type="hidden" name="id" value="<?php echo $product['id']; ?>">
                      <div class="d-grid gap-2 d-md-block">
                        <button type="submit" class="btn btn-success btn-sm" name="btn_edit"><i class="fa-solid fa-pen-to-square"></i></button>
                        <a href="../product.php?id=<?php echo $product['id']; ?>" target="_blank" class="btn btn-info btn-sm"><i class="fa-solid fa-eye"></i></a>
                        <button type="submit" class="btn btn-danger btn-sm" name="btn_delete"><i class="fa-solid fa-trash"></i></button>
                      </div>
                    </form>
                  </td>
                </tr>
    ...
    <div class="add-new">
      <div class="container">
        ...
        <div class="col-md-6 mx-auto">
          <h1><i class="fa-solid fa-plus-circle"></i> Add New Subscription Plan</h1>
