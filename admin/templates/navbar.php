  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="MyNavbar">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item"><a class="nav-link" href="edit-customers.php">Subscribers</a></li>
        <li class="nav-item"><a class="nav-link" href="edit-orders.php">Active Plans</a></li>
        <li class="nav-item"><a class="nav-link" href="./edit-products.php">Subscriptions</a></li>
